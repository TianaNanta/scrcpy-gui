...
describe("LogViewer", () => {
  ...
  it("renders log entries with timestamp, level, and message", () => {
    const logs: LogEntry[] = [
      { timestamp: "2026-02-11T10:00:00.000Z", level: "INFO", message: "Started scrcpy" },
      { timestamp: "2026-02-11T10:01:00.000Z", level: "ERROR", message: "Connection lost" },
    ];
  ...
  it("applies correct CSS class based on log level", () => {
    const logs: LogEntry[] = [
      { timestamp: "2026-02-11T10:00:00.000Z", level: "ERROR", message: "fail" },
    ];
  ...
  it("renders multiple log entries in order", () => {
    const logs: LogEntry[] = [
      { timestamp: "2026-02-11T10:00:00.000Z", level: "INFO", message: "First" },
      { timestamp: "2026-02-11T10:01:00.000Z", level: "INFO", message: "Second" },
      { timestamp: "2026-02-11T10:02:00.000Z", level: "SUCCESS", message: "Third" },
    ];
    render(<LogViewer logs={logs} />);
