      ...
      >
        <div className="row">
          <label className="input-label">
            ...
            <input
              ...
              onChange={(e) =>
                onSettingsChange({ maxFps: Number(e.target.value) })
              }
        ...
        <div className="row">
          <label className="input-label">
            ...
            <span className="hint">
              H.265 and AV1 may offer better quality at lower bitrates but
              require device support
            </span>
          </label>
        </div>
        <div className="row">
          <label className="input-label">
            ...
            <input
              ...
              onChange={(e) =>
                onSettingsChange({ videoEncoder: e.target.value })
              }
              placeholder="Default (auto-select)"
            />
            <span className="hint">
              Specific encoder name (e.g. OMX.qcom.video.encoder.avc). Leave
              empty for auto
            </span>
          </label>
        </div>
        <div className="row">
          <label className="input-label">
            ...
            <input
              ...
              onChange={(e) =>
                onSettingsChange({ videoBuffer: Number(e.target.value) })
              }
        ...
        <div className="row">
          <label className="checkbox-label">
            <input
              ...
              onChange={(e) =>
                onSettingsChange({ powerOffOnClose: e.target.checked })
              }
            />
            Power Off on Close
            <span className="hint">
        ...
        <div className="row">
          <label className="checkbox-label">
            <input
              ...
              onChange={(e) =>
                onSettingsChange({ noPowerOn: e.target.checked })
              }
            />
            Don't Power On
            <span className="hint">
