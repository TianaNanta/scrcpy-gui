        ...
        <div className="row">
          <label className="checkbox-label">
            <input
              ...
              onChange={(e) =>
                onSettingsChange({ recordingEnabled: e.target.checked })
              }
            />
            Enable Recording
          </label>
              ...
              <label className="input-label">
                ...
                <div className="input-with-button">
                  <input
                    ...
                    onChange={(e) =>
                      onSettingsChange({ recordFile: e.target.value })
                    }
                  />
                  <button onClick={selectSaveFile} className="browse-button">
                    Browse
                  </button>
                </div>
              </label>
            ...
            <div className="row">
              <label className="input-label">
                ...
                <select
                  ...
                  onChange={(e) =>
                    onSettingsChange({
                      recordFormat: e.target.value as "mp4" | "mkv",
                    })
                  }
                >
