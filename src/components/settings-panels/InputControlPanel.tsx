        ...
        <div className="row">
          <label className="input-label">
            ...
            <select
              ...
              onChange={(e) =>
                onSettingsChange({
                  keyboardMode: e.target
                    .value as DeviceSettings["keyboardMode"],
                })
              }
            >
        ...
        <div className="row">
          <label className="input-label">
            ...
            <select
              ...
              onChange={(e) =>
                onSettingsChange({
                  mouseMode: e.target.value as DeviceSettings["mouseMode"],
                })
              }
            >
              <option value="default">Default (SDK)</option>
        ...
        <div className="row">
          <label className="input-label">
            ...
            <select
              ...
              onChange={(e) =>
                onSettingsChange({
                  gamepadMode: e.target.value as DeviceSettings["gamepadMode"],
                })
              }
              disabled={!canGamepad}
            >
