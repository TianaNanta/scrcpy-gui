      ...
      >
        {!canCamera && (
          <div className="version-warning">
            <span>Camera mirroring requires scrcpy ≥ 2.2 and Android 12+</span>
          </div>
        )}
        <div className="row">
            ...
            <select
              ...
              onChange={(e) => {
                ...
                onSettingsChange({
                  ...
                  ...(val === "display"
                    ? { cameraFacing: "front", cameraSize: "", cameraId: "" }
                    : {}),
                });
              }}
            >
            ...
            <div className="row">
              <label className="input-label">
                ...
                <select
                  ...
                  onChange={(e) =>
                    onSettingsChange({
                      cameraFacing: e.target
                        .value as DeviceSettings["cameraFacing"],
                    })
                  }
                >
            ...
            <div className="row">
              <label className="input-label">
                ...
                <input
                  ...
                  onChange={(e) =>
                    onSettingsChange({ cameraSize: e.target.value })
                  }
            ...
            <div className="row">
              <label className="input-label">
                ...
                <input
                  ...
                  onChange={(e) =>
                    onSettingsChange({ cameraId: e.target.value })
                  }
                  placeholder="Auto (leave empty)"
                />
                <span className="hint">
                  Specific camera ID if the device has multiple cameras of the
