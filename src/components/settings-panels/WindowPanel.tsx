          ...
          <label className="input-label">
            ...
            <div>
              <input
                ...
                onChange={(e) =>
                  onSettingsChange({ windowX: Number(e.target.value) })
                }
                placeholder="X"
              />
              <input
                ...
                onChange={(e) =>
                  onSettingsChange({ windowY: Number(e.target.value) })
                }
                placeholder="Y"
              />
            </div>
          ...
          <label className="input-label">
            ...
            <div>
              <input
                ...
                onChange={(e) =>
                  onSettingsChange({ windowWidth: Number(e.target.value) })
                }
                placeholder="Width"
              />
              <input
                ...
                onChange={(e) =>
                  onSettingsChange({ windowHeight: Number(e.target.value) })
                }
                placeholder="Height"
              />
            </div>
            <span className="hint">Width and Height in pixels (0 = auto)</span>
          </label>
        </div>
        <div className="row">
        ...
        <div className="row">
          <label className="checkbox-label">
            <input
              ...
              onChange={(e) =>
                onSettingsChange({ windowBorderless: e.target.checked })
              }
            />
            Borderless Window
          </label>
        ...
        <div className="row">
          <label className="input-label">
            ...
            <input
              ...
              onChange={(e) =>
                onSettingsChange({ windowTitle: e.target.value })
              }
        ...
        <div className="row">
          <label className="checkbox-label">
            <input
              ...
              onChange={(e) =>
                onSettingsChange({ fullscreen: e.target.checked })
              }
            />
            Fullscreen Mode
          </label>
